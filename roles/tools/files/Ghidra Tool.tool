    ...
    <TOOL TOOL_NAME="CodeBrowser" INSTANCE_NAME="">
        <OPTIONS>
            <CATEGORY NAME="Listing Fields">
                <ENUM NAME="Cursor Text Highlight.Mouse Button To Activate" LAST_REGISTERED="2026-07-25" TYPE="enum" CLASS="ghidra.GhidraOptions$CURSOR_MOUSE_BUTTON_NAMES" VALUE="LEFT" />
                <STATE NAME="EOL Comments Field.Maximum Lines" LAST_REGISTERED="2026-07-25" TYPE="int" VALUE="10" />
                <STATE NAME="Format Code.Flag Function Entry" LAST_REGISTERED="2026-07-25" TYPE="boolean" VALUE="true" />
                <STATE NAME="Format Code.Flag Function Exits" LAST_REGISTERED="2026-07-25" TYPE="boolean" VALUE="true" />
                <STATE NAME="Format Code.Show Function Plates" LAST_REGISTERED="2026-07-25" TYPE="boolean" VALUE="false" />
                <STATE NAME="XREFs Field.Maximum Number of XREFs to Display" LAST_REGISTERED="2026-07-25" TYPE="int" VALUE="50" />
            </CATEGORY>
            <CATEGORY NAME="Decompiler">
                <ENUM NAME="Display.Brace format for function blocks" LAST_REGISTERED="2026-07-25" TYPE="enum" CLASS="ghidra.app.decompiler.DecompileOptions$BraceStyle" VALUE="Same" />
                <STATE NAME="Display.Comment line indent level" LAST_REGISTERED="2026-07-25" TYPE="int" VALUE="4" />
                <ENUM NAME="Display.Comment style" LAST_REGISTERED="2026-07-25" TYPE="enum" CLASS="ghidra.app.decompiler.DecompileOptions$CommentStyleEnum" VALUE="CPPStyle" />
                <ENUM NAME="Display.Display Namespaces" LAST_REGISTERED="2026-07-25" TYPE="enum" CLASS="ghidra.app.decompiler.DecompileOptions$NamespaceStrategy" VALUE="Never" />
                <STATE NAME="Display.Number of characters per indent level" LAST_REGISTERED="2026-07-25" TYPE="int" VALUE="4" />
            </CATEGORY>
            <CATEGORY NAME="Auto Analysis">
                <STATE NAME="Max Threads" LAST_REGISTERED="2026-07-25" TYPE="int" VALUE="12" />
            </CATEGORY>
        </OPTIONS>
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.symboltree.SymbolTreePlugin">
            <STATE NAME="NAVIGATE_INCOMING" TYPE="boolean" VALUE="false" />
            <STATE NAME="NAVIGATE_OUTGOING" TYPE="boolean" VALUE="true" />
        </PLUGIN_STATE>
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.symtable.SymbolTablePlugin">
            ...
            <STATE NAME="NAVIGATE_ON_OUTGOING_EVENT" TYPE="boolean" VALUE="true" />
        </PLUGIN_STATE>
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.datamgr.DataTypeManagerPlugin">
            ...
            <SAVE_STATE NAME="DATA_TYPES_FILTER" KEY="DATA_TYPES_FILTER" TYPE="SaveState">
                <SAVE_STATE NAME="Arrays" KEY="Arrays" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="false" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Enums" KEY="Enums" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="true" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Functions" KEY="Functions" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="true" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Other" KEY="Other" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="true" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Pointers" KEY="Pointers" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="false" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Structures" KEY="Structures" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="true" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
                <SAVE_STATE NAME="Unions" KEY="Unions" TYPE="SaveState">
                    <STATE NAME="IS_TYPE_ACTIVE" TYPE="boolean" VALUE="true" />
                    <STATE NAME="IS_TYPE_DEF_ACTIVE" TYPE="boolean" VALUE="true" />
                </SAVE_STATE>
            </SAVE_STATE>
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.script.GhidraScriptMgrPlugin">
            ...
            <ARRAY NAME="RECENT_SCRIPTS" TYPE="string" />
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.byteviewer.ByteViewerPlugin">
            ...
            <STATE NAME="Charset Name" TYPE="string" VALUE="US-ASCII" />
            <STATE NAME="Compact Chars" TYPE="boolean" VALUE="true" />
            <STATE NAME="Hex View Groupsize" TYPE="int" VALUE="1" />
            <STATE NAME="Offset" TYPE="int" VALUE="0" />
            <STATE NAME="Use Char Alignment" TYPE="boolean" VALUE="true" />
            <ARRAY NAME="View Names" TYPE="string">
                <A VALUE="Hex" />
            </ARRAY>
            <SAVE_STATE NAME="View_Widths" KEY="View_Widths" TYPE="SaveState">
        ...
        <PLUGIN_STATE CLASS="ghidra.features.codecompare.plugin.FunctionComparisonPlugin">
            <SAVE_STATE NAME="UNNAMED" KEY="CodeComparisonStates" TYPE="SaveState" />
            <SAVE_STATE NAME="UNNAMED" KEY="FunctionComparison" TYPE="SaveState" />
        </PLUGIN_STATE>
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.functiongraph.FunctionGraphPlugin">
            <SAVE_STATE NAME="COMPLEX_LAYOUT_NAME" KEY="COMPLEX_LAYOUT_NAME" TYPE="SaveState">
        ...
        <PLUGIN_STATE CLASS="ghidra.app.plugin.core.codebrowser.CodeBrowserPlugin">
            <XML NAME="Address Break">
                <FORMAT>
                    ...
                    <ROW>
                        <FIELD WIDTH="150" ENABLED="true" />
                        <FIELD NAME="Collapsed Code" WIDTH="200" ENABLED="true" />
                    </ROW>
                </FORMAT>
            </XML>
            <XML NAME="Array">
            ...
            <STATE NAME="DividerLocation" TYPE="int" VALUE="83" />
            <XML NAME="Function">
                <FORMAT>
                    <ROW>
                        <FIELD NAME="+" WIDTH="20" ENABLED="true" />
        ...
        <ROOT_NODE X_POS="409" Y_POS="179" WIDTH="1637" HEIGHT="931" EX_STATE="6" FOCUSED_OWNER="DecompilePlugin" FOCUSED_NAME="Decompiler" FOCUSED_TITLE="Decompile: main">
            <SPLIT_NODE WIDTH="100" HEIGHT="100" DIVIDER_LOCATION="0" ORIENTATION="VERTICAL">
                <SPLIT_NODE WIDTH="1621" HEIGHT="816" DIVIDER_LOCATION="148" ORIENTATION="VERTICAL">
                    ...
                    <SPLIT_NODE WIDTH="1910" HEIGHT="1047" DIVIDER_LOCATION="130" ORIENTATION="HORIZONTAL">
                        <SPLIT_NODE WIDTH="248" HEIGHT="1047" DIVIDER_LOCATION="640" ORIENTATION="VERTICAL">
                            <SPLIT_NODE WIDTH="248" HEIGHT="668" DIVIDER_LOCATION="502" ORIENTATION="VERTICAL">
                                <COMPONENT_NODE TOP_INFO="0">
                                    <COMPONENT_INFO NAME="Program Tree" OWNER="ProgramTreePlugin" TITLE="Program Trees" ACTIVE="true" GROUP="Default" INSTANCE_ID="3743426472934152666" />
                                </COMPONENT_NODE>
                                <COMPONENT_NODE TOP_INFO="0">
                                    <COMPONENT_INFO NAME="Symbol Tree" OWNER="SymbolTreePlugin" TITLE="Symbol Tree" ACTIVE="true" GROUP="Default" INSTANCE_ID="3743426472934152661" />
                                </COMPONENT_NODE>
                            </SPLIT_NODE>
                            <COMPONENT_NODE TOP_INFO="0">
                                <COMPONENT_INFO NAME="DataTypes Provider" OWNER="DataTypeManagerPlugin" TITLE="Data Type Manager" ACTIVE="true" GROUP="Default" INSTANCE_ID="3743426536553355740" />
                            </COMPONENT_NODE>
                        </SPLIT_NODE>
                        <SPLIT_NODE WIDTH="1658" HEIGHT="1047" DIVIDER_LOCATION="785" ORIENTATION="VERTICAL">
                            <SPLIT_NODE WIDTH="1386" HEIGHT="638" DIVIDER_LOCATION="705" ORIENTATION="VERTICAL">
                                <SPLIT_NODE WIDTH="1658" HEIGHT="819" DIVIDER_LOCATION="538" ORIENTATION="HORIZONTAL">
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Listing" OWNER="CodeBrowserPlugin" TITLE="Listing:  the_hinge_whisper" ACTIVE="true" GROUP="Core" INSTANCE_ID="3743426535536236996" />
                                    </COMPONENT_NODE>
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Decompiler" OWNER="DecompilePlugin" TITLE="Decompile: main" ACTIVE="true" GROUP="Default" INSTANCE_ID="3743426472934152667" />
                                        <COMPONENT_INFO NAME="Bytes" OWNER="ByteViewerPlugin" TITLE="Bytes: the_hinge_whisper" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426472934152669" />
                                        <COMPONENT_INFO NAME="Data Window" OWNER="DataWindowPlugin" TITLE="Defined Data" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536733710794" />
                                        ...
                                        <COMPONENT_INFO NAME="Equates Table" OWNER="EquateTablePlugin" TITLE="Equates Table" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536236994" />
                                        <COMPONENT_INFO NAME="External Programs" OWNER="ReferencesPlugin" TITLE="External Programs" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536236998" />
                                        <COMPONENT_INFO NAME="Functions Window" OWNER="FunctionWindowPlugin" TITLE="Functions" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536237001" />
                                        <COMPONENT_INFO NAME="Relocation Table" OWNER="RelocationTablePlugin" TITLE="Relocation Table" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536733710798" />
                                    </COMPONENT_NODE>
                                </SPLIT_NODE>
                                <SPLIT_NODE WIDTH="1386" HEIGHT="189" DIVIDER_LOCATION="495" ORIENTATION="HORIZONTAL">
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Data Type Preview" OWNER="DataTypePreviewPlugin" TITLE="Data Type Preview" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536331057622" />
                                    </COMPONENT_NODE>
                                    <COMPONENT_NODE TOP_INFO="0">
                                        <COMPONENT_INFO NAME="Virtual Disassembler - Current Instruction" OWNER="DisassembledViewPlugin" TITLE="Disassembled View" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536236993" />
                                    </COMPONENT_NODE>
                                </SPLIT_NODE>
                            </SPLIT_NODE>
                            <COMPONENT_NODE TOP_INFO="0">
                                <COMPONENT_INFO NAME="Console" OWNER="ConsolePlugin" TITLE="Console" ACTIVE="true" GROUP="Default" INSTANCE_ID="3743426472934152668" />
                                <COMPONENT_INFO NAME="Bookmarks" OWNER="BookmarkPlugin" TITLE="Bookmarks" ACTIVE="false" GROUP="Core.Bookmarks" INSTANCE_ID="3743426472934152665" />
                            </COMPONENT_NODE>
                        </SPLIT_NODE>
                    </SPLIT_NODE>
                </SPLIT_NODE>
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Call Trees" OWNER="CallTreePlugin" TITLE="Function Call Trees" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426472934152662" />
                </COMPONENT_NODE>
            </SPLIT_NODE>
            <WINDOW_NODE X_POS="426" Y_POS="178" WIDTH="1033" HEIGHT="689">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Script Manager" OWNER="GhidraScriptMgrPlugin" TITLE="Script Manager" ACTIVE="false" GROUP="Script Group" INSTANCE_ID="3743426472934152663" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="423" Y_POS="144" WIDTH="927" HEIGHT="370">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Memory Map" OWNER="MemoryMapPlugin" TITLE="Memory Map" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426472934152644" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="383" Y_POS="7" WIDTH="1020" HEIGHT="1038">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Graph" OWNER="FunctionGraphPlugin" TITLE="Function Graph" ACTIVE="false" GROUP="Function Graph" INSTANCE_ID="3743426536733710800" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="550" Y_POS="206" WIDTH="655" HEIGHT="509">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Register Manager" OWNER="RegisterPlugin" TITLE="Register Manager" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536237000" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="287" Y_POS="186" WIDTH="1424" HEIGHT="666">
                <SPLIT_NODE WIDTH="1408" HEIGHT="559" DIVIDER_LOCATION="573" ORIENTATION="HORIZONTAL">
                    <COMPONENT_NODE TOP_INFO="0">
                        <COMPONENT_INFO NAME="Symbol Table" OWNER="SymbolTablePlugin" TITLE="Symbol Table" ACTIVE="false" GROUP="symbolTable" INSTANCE_ID="3743426536733710795" />
                    </COMPONENT_NODE>
                    <COMPONENT_NODE TOP_INFO="0">
                        <COMPONENT_INFO NAME="Symbol References" OWNER="SymbolTablePlugin" TITLE="Symbol References" ACTIVE="false" GROUP="symbolTable" INSTANCE_ID="3743426536733710796" />
                    </COMPONENT_NODE>
                </SPLIT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Checksum Generator" OWNER="ComputeChecksumsPlugin" TITLE="Checksum Generator" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536236995" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Tags" OWNER="FunctionTagPlugin" TITLE="Function Tags" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536553355741" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Comment Window" OWNER="CommentWindowPlugin" TITLE="Comments" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536733710793" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="-1" Y_POS="-1" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
            ...
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="PyGhidra" OWNER="PyGhidra" TITLE="PyGhidra" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536733710792" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Source Files and Transforms" OWNER="SourceFilesTablePlugin" TITLE="Source Files and Transforms" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426535536236999" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Bundle Manager" OWNER="GhidraScriptMgrPlugin" TITLE="Bundle Manager" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426472934152664" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Defined Strings" OWNER="DefinedStringsPlugin" TITLE="Defined Strings" ACTIVE="false" GROUP="Default" INSTANCE_ID="3743426536733710797" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
            <WINDOW_NODE X_POS="0" Y_POS="0" WIDTH="0" HEIGHT="0">
                <COMPONENT_NODE TOP_INFO="0">
                    <COMPONENT_INFO NAME="Function Call Graph" OWNER="FunctionCallGraphPlugin" TITLE="Function Call Graph" ACTIVE="false" GROUP="Function Call Graph" INSTANCE_ID="3743426536331057623" />
                </COMPONENT_NODE>
            </WINDOW_NODE>
        </ROOT_NODE>
        <PREFERENCES>
            <PREFERENCE_STATE NAME="docking.widgets.filechooser.DirectoryTableModel:Filename:Size:Modified:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="Filename" WIDTH="218" VISIBLE="true" />
                        <COLUMN NAME="Size" WIDTH="218" VISIBLE="true" />
                        <COLUMN NAME="Modified" WIDTH="217" VISIBLE="true" />
                        <TABLE_SORT_STATE>
            ...
            <PREFERENCE_STATE NAME="ghidra.app.plugin.core.analysis.AnalysisEnablementTableModel:Enabled:Analyzer:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        ...
                        <COLUMN NAME="ghidra.app.plugin.core.analysis.AnalysisEnablementTableModel$AnalyzerNameColumn.Analyzer" WIDTH="378" VISIBLE="true" />
                        <TABLE_SORT_STATE />
                    </Table_State>
                </XML>
            </PREFERENCE_STATE>
            ...
            <PREFERENCE_STATE NAME="ghidra.plugin.importer.LanguageSortedTableModel:Processor:Variant:Size:Endian:Compiler:">
                <XML NAME="COLUMN_DATA">
                    <Table_State>
                        <COLUMN NAME="Processor" WIDTH="99" VISIBLE="true" />
                        <COLUMN NAME="Variant" WIDTH="183" VISIBLE="true" />
                        <COLUMN NAME="Size" WIDTH="71" VISIBLE="true" />
                        <COLUMN NAME="Endian" WIDTH="71" VISIBLE="true" />
                        <COLUMN NAME="Compiler" WIDTH="71" VISIBLE="true" />
                        <TABLE_SORT_STATE>
                            <COLUMN_SORT_STATE COLUMN_MODEL_INDEX="0" SORT_DIRECTION="ascending" SORT_ORDER="1" />
                        </TABLE_SORT_STATE>
                    </Table_State>
